...
public class EmailSenderService {
    ...
    private String buildEmailSugerencia(String tipoSensor,String idSensor, String area,String idArea,String tipoSolicitud){
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "              <h1 style=\"margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;\">Sugerencia</h1>\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "        </table>\n" +
                "        <!--[if (gte mso 9)|(IE)]>\n" +
                ...
                "              <p style=\"margin: 0;\">Se ha realizado una sugerencia  para un sensor de <i>"+tipoSensor+")</i> en el area <strong>"+area+"(ID "+idArea+")</strong>.\n" +
                "            </td>\n" +
                "          </tr>\n" +
                "          <!-- end copy -->\n" +
                "          <!-- start copy -->\n" +
